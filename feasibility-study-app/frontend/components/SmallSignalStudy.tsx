    ...
    <>
          ...
          <div className="card">
            ...
            {result?.substation_variation?.values && Object.keys(result.substation_variation.values).length > 0 && (
              <p className="phase" style={{ marginTop: 6 }}>
                Mapa: mayor variación del <b>ángulo del rotor</b> durante la perturbación por subestación
        ...
        <div>
          <div className="card">
            ...
            <p className="phase" style={{ marginTop: 8, color: "var(--warn)" }}>
              ⚠ Cálculo RMS: 2 simulaciones (sin y con planta). En <b>horas de alta generación solar</b>
      ...
      {result && (
        <>
          ...
          <div className="card">
            <h3>Análisis de autovalores y amortiguamiento</h3>
